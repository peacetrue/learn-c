...
{website}/{app-name}/[{app-name}] 用于记录学习 https://en.wikipedia.org/wiki/C_(programming_language)[C 语言^] 的过程。

== 背景（Why）

调试 Java 的时候，遇到 native 方法就会跳过，怎么做才能进入 native 方法内部呢？
...
初始提交于 2022-11-11，最近提交于 2022-11-11。
